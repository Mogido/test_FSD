$(document).ready(() => {
	$('.iqdropdown').iqDropdown({ 
		...
		if (totalItems == 0) {
		document.querySelector('.iqdropdown-selection').innerHTML = textPlural
		} else {
